...
import wx.eigle.yf.com.mafengwo_app.Fragment.Fragment_2.Fragment1_1;
import wx.eigle.yf.com.mafengwo_app.Fragment.Fragment_2.Fragment1_2;
import wx.eigle.yf.com.mafengwo_app.Fragment.Fragment_2.Fragment1_3;
import wx.eigle.yf.com.mafengwo_app.Fragment.Fragment_2.Fragment1_4;
import wx.eigle.yf.com.mafengwo_app.Fragment.Fragment_2.Fragment1_5;
...
public class Fragment1 extends Fragment{
    ...
    private final String[] mTitles = {"推荐","汽车","家居","数码","游戏"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fragmentList.add(new Fragment1_5());
        mAdapter = new MyPageerAdapter(getChildFragmentManager(),fragmentList);
        vp.setAdapter(mAdapter);
        SlidingTabLayout tabLayout_1 = (SlidingTabLayout) view.findViewById(R.id.tablayout);
